...
public class BaseDatos extends SQLiteOpenHelper {
    ...
    public static final String tablaUsuario="create table usuario(id_usu integer primary key autoinrement," +
            "apellidos_usu text,nombres_usu text, email_usu text, password_usu text, telefono_usu text, direccion_usu text)" ;//definiendo la estructura de la tabla usuario
//constructor
    public BaseDatos(Context contexto) {super(contexto,nombreBdd, factory null, versionBdd)}
